      ...
      <div className="container-custom">
        ...
        <div className="flex justify-between items-center">
          ...
          <Link to="/" className="flex items-center">
            <img src="/lovable-uploads/8a64a688-6c5b-4b55-ab6e-7fe5dc86a71a.png" alt="EPIS Moriá Logo" className="h-24 mr-2 transition-all duration-300 transform hover:scale-[1.02]" />
          </Link>
